...
const ProfileView = ({ profile, sections }) => {
  ...
  const editButton = (
    <Button variant="secondary" className="px-16" onClick={() => setEditing(true)}>
  ...
  return (
    <div className="flex flex-col gap-24 px-16 pt-22 pb-52 lg:p-24 xl:px-34 xl:pt-32 lg:pb-56">
      ...
      <div className="flex flex-col gap-16 md:flex-row md:items-start xl:gap-24">
