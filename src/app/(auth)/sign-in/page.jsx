  ...
  return (
    <div>
      <div className="flex flex-col">
        ...
        <h1 className="font-playfair text-[24px]/[32px] font-medium italic mb-8 text-text-primary sm:text-[28px]/[36px] md:text-display-sm">
          Sign in to your account
        </h1>
        <p className="text-body text-text-secondary mb-32 md:mb-16">
      ...
      <p className=" flex justify-center items-center gap-5 text-body-xs text-text-secondary mt-16">
        New to Kapuria?{" "}
