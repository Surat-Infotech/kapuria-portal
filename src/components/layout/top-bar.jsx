...
const TopBar = ({ user, searchPlaceholder = "Search this property…" }) => (
  <header className="hidden border-b border-border-subtle bg-background px-34 py-14 lg:block">
    <div className="flex items-center justify-between">
      <div className="flex h-42 w-280 items-center gap-9 rounded-[11px] border border-border-default bg-surface px-16 py-8 focus-within:border-gold-400">
      ...
      <button
        type="button"
        className="flex h-42 items-center gap-8 rounded-xl border border-border-default bg-surface px-8 py-4 transition-colors hover:bg-surface-sunken"
      >
        <span
